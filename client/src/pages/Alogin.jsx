...
const Alogin = () => {
    ...
    return (<div className='main text-white'>
      ...
      <div className='flex justify-center flex-col items-center h-[80vh]  '>
          <form action="" className='flex flex-col shadow-xl backdrop-blur-3xl rounded-2xl rounded-r-2xl border-gray-400 lg:p-4 w-[360px] sm:w-[600px] sm:p-15 p-4 lg:w-[600px]' onSubmit={handleSubmit}>
          <h1 className='text-3xl font-semibold text-center mb-4'>FACULTY LOGIN</h1>
